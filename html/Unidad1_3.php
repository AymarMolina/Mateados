...
<body>
    <div class="container">
        ...
        <p>Arrastra la imagen 10 veces al área designada.</p>
        ...
        <button id="continuarBtn" class="btn" onclick="location.href='ejercicio04primergrado.php'">Continuar con el Siguiente Ejercicio</button>
    </div>
